...
<template>
  <div ref="dockRef" class="dock" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
    <div class="dock-container">
      <!-- Toggle Button -->
      <div class="dock-toggle" @click="handleMouseEnter">
        <div class="toggle-inner">
          <div class="icon-container">
            <Layers v-if="!isExpanded" class="icon" />
      ...
      <div class="menu-container">
        <template v-for="(item, index) in routes" :key="item.path || item.id">
          <div
            class="menu-item"
            :title="item.label"
