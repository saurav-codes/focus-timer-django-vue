  ...
  <div class="register-container">
    <div class="register-card">
      ...
      <div class="card-header">
        ...
        <p class="subtitle">Join Tymr Online</p>
      </div>
      ...
      <form class="register-form" @submit.prevent="handleRegister">
        ...
        <div class="form-group">
          ...
          <input
            ...
            required
            autocomplete="new-password" />
          <div v-if="confirmPassword && !passwordsMatch" class="password-mismatch">Passwords do not match</div>
        ...
        <div class="terms-agreement">
          <input id="agree-terms" v-model="agreeToTerms" type="checkbox" required />
          <label for="agree-terms">
            I agree to the <a href="/terms-and-conditions" target="_blank" class="terms-link">Terms of Service</a> and
      ...
      <div class="card-footer">
        <p>Already have an account? <button class="text-button" @click="goToLogin">Log in</button></p>
      </div>
    </div>
  </div>
</template>
