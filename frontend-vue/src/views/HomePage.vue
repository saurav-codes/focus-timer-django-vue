...
<template>
  <div class="homepage">
    ...
    <header class="header">
      <div class="container">
        <div class="logo-container">
          <h1 class="logo">Tymr<span> Online</span></h1>
        </div>
    ...
    <section class="hero">
      <div class="container">
        <div class="hero-content">
          ...
          <p class="hero-subtitle">Create, organize, and track your tasks effortlessly.</p>
          <div class="hero-cta">
        ...
        <div class="hero-image">
          <div class="video-wrapper">
            <video src="@/assets/demo.mp4" autoplay loop muted playsinline class="hero-img placeholder" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="features" class="features">
      <div class="container">
        <h2 class="section-title">Why choose Tymr Online?</h2>
        <div class="feature-grid">
          <div class="feature-card">
            ...
            <p class="feature-description">
              Quickly capture thoughts and tasks without disrupting your flow. Move seamlessly from ideas to organized
              plans.
            </p>
          </div>
          <div class="feature-card">
    ...
    <footer class="footer">
      <div class="footer-bottom">
        ...
        <p class="copyright">© 2025 Tymr Online. All rights reserved.</p>
      </div>
    </footer>
  </div>
</template>
