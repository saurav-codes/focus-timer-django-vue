...
def get_calendar_events(request):
    ...
    try:
        ...
        credentials_obj = GoogleCalendarCredentials.objects.filter(user=request.user).first()
        ...
        try:
            ...
            formatted_events = [format_event_for_fullcalendar(event) for event in events]
...
def disconnect_google_calendar(request):
    ...
    try:
        ...
        deleted, _ = GoogleCalendarCredentials.objects.filter(user=request.user).delete()
